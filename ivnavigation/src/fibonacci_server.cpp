...
#include <ivnavigation/FibonacciAction.h>
#include <ros/ros.h>
...
protected:
  ...
  // error may occur.
  actionlib::SimpleActionServer<ivnavigation::FibonacciAction> as_;
  std::string action_name_;
  // create messages that are used to published feedback/result
  ivnavigation::FibonacciFeedback feedback_;
  ivnavigation::FibonacciResult result_;
...
public:
  ...
  void executeCB(const ivnavigation::FibonacciGoalConstPtr &goal) {
    // helper variables
    ros::Rate r(1);
    bool success = true;
