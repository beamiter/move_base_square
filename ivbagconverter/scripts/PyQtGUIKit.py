...
if __name__ == '__main__':
    ...
    #  optList=PyQtGUIKit.GetCheckButtonSelect(["sample a","sample b","sample c"], title="Select sample", msg="Please select sample")
    #  print optList
    filePath=PyQtGUIKit.GetFilePath(caption=u"Select files",filefilter="*py")
    print filePath
