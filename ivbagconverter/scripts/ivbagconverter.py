...
# -*- coding: utf-8 -*-
import sys
from PyQtGUIKit import PyQtGUIKit
...
def main(options):
    ...
    #GetFilePath
    files=PyQtGUIKit.GetFilePath(isApp=True,caption="Select bag file",filefilter="*bag")
    #  print files
    if len(files)<1:
    ...
    selected=PyQtGUIKit.GetCheckButtonSelect(topics,app=app,msg="Select topics to convert csv files")
...
if __name__ == '__main__':
    ...
    print "Start converting the rosbag to csv!!"
